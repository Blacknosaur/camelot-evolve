...
struct CompositionPlayerView: View {
    ...
    init(composition: VideoComposition, allowsDeletion: Bool = false) {
        self.composition = composition; self.allowsDeletion = allowsDeletion
        ...
        Group {
            if let player {
                ...
                ContentUnavailableView {
                    ...
                    if allowsDeletion { VideoDeletionButton(composition: composition) { dismiss() } }
